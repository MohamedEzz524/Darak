...
export default function Page(){
  const content = read("pages/about-us.html");
  const style = read("pages/about-us.style.html");
  const scripts = readJSON("pages/about-us.scripts.json");
  return (
    <>
      ...
      <SiteScripts scripts={scripts} k="page-about-us" />
    </>
  );
}
