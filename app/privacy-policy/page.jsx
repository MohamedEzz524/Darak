...
export default function Page(){
  const content = read("pages/privacy-policy.html");
  const style = read("pages/privacy-policy.style.html");
  const scripts = readJSON("pages/privacy-policy.scripts.json");
  return (
    <>
      ...
      <SiteScripts scripts={scripts} k="page-privacy-policy" />
    </>
  );
}
