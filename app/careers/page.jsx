...
export default function Page(){
  const content = read("pages/careers.html");
  const style = read("pages/careers.style.html");
  const scripts = readJSON("pages/careers.scripts.json");
  return (
    <>
      ...
      <SiteScripts scripts={scripts} k="page-careers" />
    </>
  );
}
