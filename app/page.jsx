...
export default function Page(){
  const content = read("pages/index.html");
  const style = read("pages/index.style.html");
  const scripts = readJSON("pages/index.scripts.json");
  return (
    <>
      ...
      <SiteScripts scripts={scripts} k="page-index" />
    </>
  );
}
