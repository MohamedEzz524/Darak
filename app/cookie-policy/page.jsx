...
export default function Page(){
  const content = read("pages/cookie-policy.html");
  const style = read("pages/cookie-policy.style.html");
  const scripts = readJSON("pages/cookie-policy.scripts.json");
  return (
    <>
      ...
      <SiteScripts scripts={scripts} k="page-cookie-policy" />
    </>
  );
}
